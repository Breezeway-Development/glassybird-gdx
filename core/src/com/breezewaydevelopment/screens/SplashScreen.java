...
public class SplashScreen implements Screen {
	...
	private void setupTween() {
		...
		Tween.to(sprite, SpriteAccessor.ALPHA, 1.7f).target(1).ease(TweenEquations.easeInOutQuad).repeatYoyo(1, .2f).setCallback(cb).setCallbackTriggers(TweenCallback.COMPLETE).start(manager);
	}
