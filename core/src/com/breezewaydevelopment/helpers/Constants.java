...
public final class Constants {
	...
	public static float SCREEN_WIDTH, SCREEN_HEIGHT, GAME_WIDTH, GAME_HEIGHT, MIDPOINT_Y;
	...
	public static void load() {
		...
		GAME_WIDTH = 136;
		GAME_HEIGHT = SCREEN_HEIGHT * (GAME_WIDTH / GAME_HEIGHT); // 240 - Scale the height by the aspect ratio
		MIDPOINT_Y = GAME_HEIGHT / 2;
		
		Bird.START_X = GAME_WIDTH / 3;
